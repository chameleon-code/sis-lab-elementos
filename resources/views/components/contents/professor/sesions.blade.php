    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            ...
            @else --}}
                ...
                <div class="text-center" id="sesions-title">
                </div>
                ...
                {{-- @foreach ($sesions as $sesion)
                    ...
                    @foreach ($sesion as $s)
                        ...
                        <div id="sesions-container" class="">
                            {{-- <thead>
                                <tr>
                                    <div class="accordion-body bg-gray-300 rounded row" style="cursor: default;">
                                        <div class="container d-flex justify-content-between p-1" style="">
                                            ...
                                            <div class="d-flex justify-content-end">
                                                <div class="mx-4">
                                                    <a id="sesion-badge-{{$s->id}}" href="#" class="mx-2" onclick="showSesion({{$s}}), loadPractice({{$s->id}})" data-toggle-2="tooltip" title="Guía práctica"><i class="fas fa-book-open"></i></a>
                                                </div>
                                                <div class="text-center" onclick="showAccordion({{$s->id}})" style="cursor: pointer; width: 18px;">
                                                    <strong id="arrowAccordion{{$s->id}}" style="color: #8b8b8b; font-weight: bold;">&#709;</strong>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                ...
                {{-- @if($sesions!=null)
                    @foreach ($blocks as $key => $block)
                        <div id="block-{{$block->block_id}}" class="blocks-sesions" style="display: none;">
                            ...
                            <div class="text-center">
                                <label class="h5 text-gray-900 mb-4">Sesiones ({{ $subjects[$key] }})</label>
                            </div>
